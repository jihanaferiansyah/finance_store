...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 09, 2020 at 01:58 PM
...
(15, 40000, '2019-10-27', 'Riza', 'Uang Bensin'),
(16, 80000, '2019-10-28', 'Riza', 'Mau Nikahan'),
(17, 1000000, '2019-10-29', 'Riza', 'Biaya lahiran anak'),
(18, 280000, '2020-07-11', 'Buat Makan', 'Joni'),
(19, 150000, '2020-07-13', 'Biaya Transportasi', 'Doni');
...
(7, 'WAIS ALQORNI', 'Staff IT', 'Yogyakarta', 28, '085772002003');
...
(24, '2020-07-11', 2200000, 2),
(25, '2020-07-13', 12150000, 3);
...
ALTER TABLE `pemasukan`
 ADD PRIMARY KEY (`id_pemasukan`), ADD KEY `id_sumber` (`id_sumber`);

--
-- Indexes for table `pengeluaran`
--
ALTER TABLE `pengeluaran`
 ADD PRIMARY KEY (`id_pengeluaran`), ADD KEY `id_sumber` (`id_sumber`);
